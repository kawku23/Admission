...
<head>
  ...
  <title>CCTV University</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="view/img/logo1.png" rel="icon">
  <link href="view/img/logo1.png" rel="apple-touch-icon">
...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <h1 class="sitename">CCTV University</h1><span>.</span>
      </a>
      ...
      <a class="btn-getstarted" href="index.html#about">Apply Now</a>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      ...
      <img src="view/img/hero-bg.jpg" alt="" data-aos="fade-in">

      <div class="container">
        <div class="row">
          <div class="col-lg-10">
            <h2 data-aos="fade-up" data-aos-delay="100">Welcome to Our Website</h2>
            <p data-aos="fade-up" data-aos-delay="200">Make an Impact with an Online Master's Degree</br> in Sustainability, Entrepreneurship, and Technology</p>
          </div>
          <div class="col-lg-5">
              <input type="submit" class="btn btn-primary" value="Get brochure">
  ...
  <script src="view/vendor/purecounter/purecounter_vanilla.js"></script>
